...
class TextStyles {
  ...
  static TextStyle font28PrimaryColorW600 = TextStyle(
    fontSize: 16.sp,
    color: AppColors.primaryColor,
  ...
  static TextStyle font40WhiteColorW400 = TextStyle(
    fontSize: 40.sp,
    color: AppColors.whiteColor,
  ...
  static TextStyle font28PrimaryColorW400 = TextStyle(
    fontSize: 28.sp,
    color: AppColors.whiteColor,
    fontWeight: FontWeight.w400,
    fontFamily: 'BebasNeue',
  ...
  static TextStyle font14BebasNeueW400 = TextStyle(
    fontSize: 14.sp,
    color: AppColors.primaryColor,
    fontWeight: FontWeight.w400,
    fontFamily: 'BebasNeue',
  ...
  ///Inter font
  static TextStyle font14BlackColorW700 = TextStyle(
    fontSize: 14.sp,
    color: AppColors.blackColor,
    fontWeight: FontWeight.w700,
    fontFamily: 'Inter',
  ...
  static TextStyle font22WhiteColorW600 = TextStyle(
    fontSize: 22.sp,
    color: AppColors.whiteColor,
    fontWeight: FontWeight.w600,
    fontFamily: 'Inter',
  );
  static TextStyle font14greyColorColorW400 = TextStyle(
    fontSize: 14.sp,
  ...
  static TextStyle font14whiteColorColorW400 = TextStyle(
    fontSize: 14.sp,
    color: AppColors.whiteColor,
    fontWeight: FontWeight.w400,
    fontFamily: 'Inter',
  ...
  static TextStyle font12BlackColorColorW500 = TextStyle(
    fontSize: 12.sp,
    color: AppColors.blackColor,
    fontWeight: FontWeight.w400,
    fontFamily: 'Inter',
  ...
  static TextStyle font14greyColorColor79W400 = TextStyle(
    fontSize: 14.sp,
    color: AppColors.greyColorColor79,
    fontWeight: FontWeight.w400,
    fontFamily: 'Inter',
  );
  static TextStyle font12greyColorColor79W400 = TextStyle(
    fontSize: 12.sp,
    color: AppColors.greyColorColor79,
    fontWeight: FontWeight.w400,
    fontFamily: 'Inter',
  );
  static TextStyle font10WhiteColorW400 = TextStyle(
    fontSize: 10.sp,
    color: AppColors.whiteColorEb,
    fontWeight: FontWeight.w400,
    fontFamily: 'Inter',
  ...
  static TextStyle font16WhiteColorW500 = TextStyle(
    fontSize: 16.sp,
    color: AppColors.whiteColor,
    fontWeight: FontWeight.w500,
    fontFamily: 'Inter',
  ...
  static TextStyle font16primaryColorW600 = TextStyle(
    fontSize: 16.sp,
    color: AppColors.primaryColor,
    fontWeight: FontWeight.w600,
    fontFamily: 'Inter',
  ...
  static TextStyle font18WhiteColor700 = TextStyle(
    fontSize: 18.sp,
    color: AppColors.whiteColor,
    fontWeight: FontWeight.w700,
    fontFamily: 'Inter',
  ...
  static TextStyle font13whiteColorW400 = TextStyle(
    fontSize: 13.sp,
    fontWeight: FontWeight.w400,
    fontFamily: 'Inter',
  );
  ...
  static TextStyle font18InterW400 = TextStyle(
    fontFamily: "Inter",
    fontWeight: FontWeight.w400,
    color: AppColors.whiteColor,
    fontSize: 18.sp,
  ...
  static TextStyle font10InterW400 = TextStyle(
    fontSize: 10.sp,
    fontWeight: FontWeight.w400,
    color: Colors.white,
    fontFamily: "Inter",
