...
class Step16Screen extends StatelessWidget {
  const Step16Screen({super.key});
      ...
      body: SafeArea(
        ...
        child: Column(
          ...
          children: [
              ...
              child: Text.rich(
                ...
                TextSpan(
                  children: [
                    ...
                    TextSpan(
                      text: 'you dislike or Prefer not to include in your ',
                      style: TextStyles.font24w600.copyWith(
                        color: AppColors.whiteColor,
                      ),
                    ),
            ...
            BlocBuilder<Step16Cubit, Step16State>(
              ...
              builder: (context, state) {
                return Padding(
                  padding: EdgeInsets.symmetric(horizontal: 16.w),
                  child: Column(
                    children: Step16Cubit.get(context).yesAndNo
                        .map(
                          (item) => GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: Text(
                                item.name,
                                style:
                                    Step16Cubit.get(context).selectedWeightId ==
                                        item.id
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  Text(
                    "If you have a Foods you dislike, write it here.",
                    style: TextStyles.font14greyColorColor79W400,
                  ),
                ],
              ),
            ...
            Padding(
              ...
              child: AppTextFormField(
                ...
                controller: Step16Cubit.get(context).targetWeight,
            ...
            Spacer(),
            BlocConsumer<Step16Cubit, Step16State>(
              // buildWhen: (previous, current) {
              ...
              listener: (context, state) {
                if (state is Step16SuccessState) {
                  context.completeOnboardingStepOrGo(Routes.step17Screen);
                } else if (state is Step16ErrorState) {
              ...
              builder: (context, state) {
                return Container(
                  ...
                  child: ButtonWidget(
                    isLoading: state is Step16LoadingState,
                    borderRadius: 50,
                    buttonHeight: 46.h,
                    buttonText: "Next",
                    ...
                    onPressed: () {
                      Step16Cubit.get(context).sendStep();
                    },
                  ),
                );
              },
