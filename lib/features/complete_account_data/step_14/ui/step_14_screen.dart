...
class Step14Screen extends StatelessWidget {
  const Step14Screen({super.key});
      ...
      body: SafeArea(
        ...
        child: Column(
          ...
          children: [
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    BlocBuilder<Step14Cubit, Step14State>(
                      ...
                      builder: (context, state) {
                        return Padding(
                          padding: EdgeInsets.symmetric(horizontal: 16.w),
                          child: Column(
                            children: Step14Cubit.get(context).yesAndNo
                                .map(
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Expanded(
                            child: Text(
                              "If you have a dietary restrictions, Choose from the following options.",
                              style: TextStyles.font14greyColorColor79W400,
                            ),
                          ),
                        ],
                    ...
                    BlocBuilder<Step14Cubit, Step14State>(
                      ...
                      builder: (context, state) {
                        return Padding(
                          padding: EdgeInsets.symmetric(horizontal: 16.w),
                          child: Column(
                            children: Step14Cubit.get(context).dietItemItems
                                .map(
                                  (item) => GestureDetector(
                                    onTap: () {
                                      Step14Cubit.get(
            ...
            BlocConsumer<Step14Cubit, Step14State>(
              // buildWhen: (previous, current) {
              ...
              listener: (context, state) {
                if (state is Step14SuccessState) {
                  context.completeOnboardingStepOrGo(Routes.step15Screen);
                } else if (state is Step14ErrorState) {
              ...
              builder: (context, state) {
                return Container(
                  ...
                  child: ButtonWidget(
                    isLoading: state is Step14LoadingState,
                    borderRadius: 50,
                    buttonHeight: 46.h,
                    buttonText: "Next",
