...
class Step13Screen extends StatelessWidget {
      ...
      body: SafeArea(
        ...
        child: Column(
          ...
          children: [
            ...
            BlocBuilder<Step13Cubit, Step13State>(
              ...
              builder: (context, state) {
                return Padding(
                  padding: EdgeInsets.symmetric(horizontal: 16.w),
                  child: Column(
                    children: Step13Cubit.get(context).timesItems
                        .map(
            ...
            Spacer(),
            BlocConsumer<Step13Cubit, Step13State>(
              // buildWhen: (previous, current) {
              ...
              listener: (context, state) {
                if (state is Step13SuccessState) {
                  context.completeOnboardingStepOrGo(Routes.step14Screen);
                } else if (state is Step13ErrorState) {
              ...
              builder: (context, state) {
                return Container(
                  ...
                  child: ButtonWidget(
                    isLoading: state is Step13LoadingState,
                    borderRadius: 50,
                    buttonHeight: 46.h,
                    buttonText: "Next",
                    ...
                    onPressed: () {
                      Step13Cubit.get(context).sendStep();
                    },
                  ),
                );
              },
