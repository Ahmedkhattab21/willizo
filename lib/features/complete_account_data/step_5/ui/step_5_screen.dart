          ...
          children: [
            ...
            BlocConsumer<Step5Cubit, Step5State>(
              listener: (context, state) {
                if (state is Step5SuccessState) {
                  context.completeOnboardingStepOrGo(Routes.step6Screen);
                } else if (state is Step5ErrorState) {
              ...
              builder: (context, state) {
                return Container(
                  ...
                  child: ButtonWidget(
                    isLoading: state is Step5LoadingState,
                    borderRadius: 50,
                    buttonHeight: 46.h,
                    buttonText: "Next",
                    ...
                    onPressed: () {
                      Step5Cubit.get(context).sendStep();
                    },
                  ),
                );
              },
