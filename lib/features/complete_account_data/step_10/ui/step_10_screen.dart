      ...
      body: SafeArea(
        ...
        child: Column(
          ...
          children: [
            ...
            BlocBuilder<Step10Cubit, Step10State>(
              ...
              builder: (context, state) {
                return Padding(
                  padding: EdgeInsets.symmetric(horizontal: 16.w),
                  child: Column(
                    children: Step10Cubit.get(context).levelsItems
                        .map(
                          (item) => GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: Text(
                                item.name,
                                style:
                                    Step10Cubit.get(context).selectedWeightId ==
                                        item.id
            ...
            Spacer(),
            BlocConsumer<Step10Cubit, Step10State>(
              // buildWhen: (previous, current) {
              ...
              listener: (context, state) {
                if (state is Step10SuccessState) {
                  context.completeOnboardingStepOrGo(Routes.step11Screen);
                } else if (state is Step10ErrorState) {
              ...
              builder: (context, state) {
                return Container(
                  ...
                  child: ButtonWidget(
                    isLoading: state is Step10LoadingState,
                    borderRadius: 50,
                    buttonHeight: 46.h,
                    buttonText: "Next",
                    ...
                    onPressed: () {
                      Step10Cubit.get(context).sendStep();
                    },
                  ),
                );
              },
