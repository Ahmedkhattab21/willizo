      ...
      body: SafeArea(
        ...
        child: Column(
          ...
          children: [
            ...
            BlocBuilder<Step9Cubit, Step9State>(
              ...
              builder: (context, state) {
                return Padding(
                  padding: EdgeInsets.symmetric(horizontal: 16.w),
                  child: Column(
                    children: Step9Cubit.get(context).levelsItems
                        .map(
                          (item) => GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: Text(
                                item.name,
                                style:
                                    Step9Cubit.get(context).selectedWeightId ==
                                        item.id
            ...
            Spacer(),
            BlocConsumer<Step9Cubit, Step9State>(
              // buildWhen: (previous, current) {
              ...
              listener: (context, state) {
                if (state is Step9SuccessState) {
                  context.completeOnboardingStepOrGo(Routes.step10Screen);
                } else if (state is Step9ErrorState) {
              ...
              builder: (context, state) {
                return Container(
                  ...
                  child: ButtonWidget(
                    isLoading: state is Step9LoadingState,
                    borderRadius: 50,
                    buttonHeight: 46.h,
                    buttonText: "Next",
                    ...
                    onPressed: () {
                      Step9Cubit.get(context).sendStep();
                    },
                  ),
                );
              },
