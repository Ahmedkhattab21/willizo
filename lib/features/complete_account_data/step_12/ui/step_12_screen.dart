      ...
      body: SafeArea(
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text.rich(
                ...
                TextSpan(
                  children: [
                    TextSpan(
                      text: 'Do you have any injuries or ',
            ...
            BlocBuilder<Step12Cubit, Step12State>(
              ...
              builder: (context, state) {
                return Padding(
                  padding: EdgeInsets.symmetric(horizontal: 16.w),
                  child: Column(
                    children: Step12Cubit.get(context).yesAndNo
                        .map(
                          (item) => GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: Text(
                                item.name,
                                style:
                                    Step12Cubit.get(context).selectedWeightId ==
                                        item.id
            ...
            Padding(
              ...
              child: AppTextFormField(
                ...
                controller: Step12Cubit.get(context).targetWeight,
            ...
            Spacer(),
            BlocConsumer<Step12Cubit, Step12State>(
              // buildWhen: (previous, current) {
              ...
              listener: (context, state) {
                if (state is Step12SuccessState) {
                  context.completeOnboardingStepOrGo(Routes.step13Screen);
                } else if (state is Step12ErrorState) {
              ...
              builder: (context, state) {
                return Container(
                  ...
                  child: ButtonWidget(
                    isLoading: state is Step12LoadingState,
                    borderRadius: 50,
                    buttonHeight: 46.h,
                    buttonText: "Next",
                    ...
                    onPressed: () {
                      Step12Cubit.get(context).sendStep();
                    },
                  ),
                );
              },
