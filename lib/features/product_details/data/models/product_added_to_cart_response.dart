class ProductAddedToCartResponse {
  final String message;
  final CartData cart;

  ProductAddedToCartResponse({required this.message, required this.cart});

  factory ProductAddedToCartResponse.fromJson(Map<String, dynamic> json) {
