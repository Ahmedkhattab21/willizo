...
extension Foundation.Bundle {
    ...
    static let module: Bundle = {
        let bundleName = "path_provider_foundation_path_provider_foundation"
        ...
        fatalError("unable to find bundle named path_provider_foundation_path_provider_foundation")
    }()
}