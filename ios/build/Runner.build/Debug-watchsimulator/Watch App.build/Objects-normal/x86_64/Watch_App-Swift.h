...
#ifndef WATCH_APP_SWIFT_H
#define WATCH_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Watch_App",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC9Watch_App24PhoneConnectivityService")
@interface PhoneConnectivityService : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class WCSession;
@class NSString;
@interface PhoneConnectivityService (SWIFT_EXTENSION(Watch_App)) <WCSessionDelegate>
